# sdkwork-github Source Configuration
...
| `runtimeCode` | `github` |
| Config root | `/etc/sdkwork/github/` |
| Runtime TOML | `/etc/sdkwork/github/config.toml` |
| Secrets | `/etc/sdkwork/github/secrets/` |
| Override | `SDKWORK_GITHUB_CONFIG_FILE` |
