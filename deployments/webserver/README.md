...
| --- | --- | ---: | --- | --- |
| development | `server.development.toml` | 14 | `github-dev.sdkwork.com` | 80 |
| test | `server.test.toml` | 14 | `github-test.sdkwork.com` | 80 |
| staging | `server.staging.toml` | 14 | `github-staging.sdkwork.com` | 80 |
| demo | `server.demo.toml` | 14 | `github-demo.sdkwork.com` | 80 |
| production | `server.production.toml` | 14 | `github.sdkwork.com` | 443 ssl + 80 |
