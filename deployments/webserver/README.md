...
Module `sdkwork-github` · runtime code `github` · enabled
...
| --- | --- | ---: | --- | --- |
| development | `server.development.toml` | 16 | `github-dev.sdkwork.com` | 80 |
| test | `server.test.toml` | 16 | `github-test.sdkwork.com` | 80 |
| staging | `server.staging.toml` | 16 | `github-staging.sdkwork.com` | 80 |
| demo | `server.demo.toml` | 16 | `github-demo.sdkwork.com` | 80 |
| production | `server.production.toml` | 16 | `github.sdkwork.com` | 443 ssl + 80 |
