# Runbook — sdkwork-github deploy / upgrade / rollback (EN)
...
targets. Image reference: `registry.sdkwork.com/apps/sdkwork-github-standalone:0.1.0`
...
install syncs the bundle to `/opt/deploy/sdkwork-github/bundle`, loads the image, starts
